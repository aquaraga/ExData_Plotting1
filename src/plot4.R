...
par(mfcol = c(2, 2))
with(feb.data, plot(DateTime, Global_active_power, ylab = "Global Active Power", xlab = "", type = "l"))
...
legend("topright", col = c("black", "red", "blue"), lty = c(1, 1, 1), legend = c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"), cex = 0.95, bty = "n")

with(feb.data, plot(DateTime, Voltage, xlab = "datetime", type = "l"))

with(feb.data, plot(DateTime, Global_reactive_power, xlab = "datetime", type = "l"))
